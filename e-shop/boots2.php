	...
	font-size:23px;">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <form class="navbar-form navbar-left" method="POST" action="boots2.php">
	...
	<div class="container" style="margin-top:100px">
			<div id="ul-div">
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><li><a href="basketball.php">Kits&Jerseys</a></li></div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><li><a href="boots2.php" class="active">Boots</a></li></div>
					</ul>
			</div>
		</div>
		<div class="body">
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=43'>
						<img src="img/prod25.webp" class="product  img-rounded"><br/>
							<p class="description-title">Nike Kyrie 4</p>
							<hr>
							<p class="description">Basketball Boots<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='43'";
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=44'>
						<img src="img/prod26.webp" class="product  img-rounded"><br/>
							<p class="description-title">Nike PG 2</p>
							<hr>
							<p class="description">Basketball Boots<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='44'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=45'>
						<img src="img/prod27.webp" class="product  img-rounded"><br/>
							<p class="description-title">Nike Mamba</p>
							<hr>
							<p class="description">Basketball Boots<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='45'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=46'>
						<img src="img/prod28.webp" class="product  img-rounded"><br/>
							<p class="description-title">Adidas Crazy Light</p>
							<hr>
							<p class="description">Basketball Boots<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='46'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=47'>
						<img src="img/prod29.webp" class="product  img-rounded"><br/>
							<p class="description-title">Adidas Crazy Explosive</p>
							<hr>
							<p class="description">Basketball Boots<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='47'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=48'>
						<img src="img/prod30.webp" class="product  img-rounded"><br/>
							<p class="description-title">Adidas Harden Vol.2</p>
							<hr>
							<p class="description">Basketball Boots<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='48'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
