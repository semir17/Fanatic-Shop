	...
	font-size:23px;">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <form class="navbar-form navbar-left" method="POST" action="football.php">
	...
	<div class="container" style="margin-top:100px">
			<div id="ul-div">
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><li><a href="football.php" class="active">Kits&Jerseys</a></li></div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><li><a href="boots.php">Boots</a></li></div>
					</ul>
			</div>
		</div>
		<div class="body">
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=1'>
						<img src="img/prod1.png" class="product  img-rounded"><br/>
							<p class="description-title">2019/20 FFF Home Shirt</p>
							<hr>
							<p class="description">Football Shirt<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='1'";
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=2'>
						<img src="img/prod2.png" class="product  img-rounded"><br/>
							<p class="description-title">2019/20 FC Barcelona Home Shirt</p>
							<hr>
							<p class="description">Football Shirt<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='2'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=3'>
						<img src="img/prod3.png" class="product  img-rounded"><br/>
							<p class="description-title">2019/20 Tottenham Home Shirt</p>
							<hr>
							<p class="description">Football Shirt<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='3'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=28'>
						<img src="img/prod10.png" class="product  img-rounded"><br/>
							<p class="description-title">2019/20 Real Madrid Home Shirt</p>
							<hr>
							<p class="description">Football Shirt<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='28'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=29'>
						<img src="img/prod11.png" class="product  img-rounded"><br/>
							<p class="description-title">2019/20 Juventus Away Shirt</p>
							<hr>
							<p class="description">Football Shirt<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='29'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
					<a href='product.php?p=30'>
						<img src="img/prod12.png" class="product  img-rounded"><br/>
							<p class="description-title">2019/20 Ajax Away Shirt</p>
							<hr>
							<p class="description">Football Shirt<br/>
								<?php
								$sql="SELECT price FROM product WHERE `id`='30'";
								$result=mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($result);
								echo $row['price'];
							?>
